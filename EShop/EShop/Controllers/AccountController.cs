...
using EShop.Models.ViewModels.AccountViewModels;
...
namespace EShop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var shoppingCart = await _shoppingCartService.CreateNewShoppingCart(HttpContext);
                ...
                if (result.Succeeded)
                {
                    ...
                    var ctokenLink = Url.Action("ConfirmEmail", "Account", new {userId = user.Id, token = ctoken},
        ...
        {
            if (userId == null || token == null) return View("Error"); //, new { ShowRequestId = true, RequestId = 1 });
